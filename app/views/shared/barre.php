<!-- template for the header containing the logo and social media links -->


<div class="flex justify-between  ">

    <div class="my-2 mx-2">
        <img class="h-24 w-24" src="<?php echo SERVER_ROOT ?>/img/logo.png" alt="Workflow">
    </div>
    ...
    <div class="my-6 mx-6">
        <div class="flex items-stretch">
            ...
            <a target="_blank" href="https://web.facebook.com/ESI.Page/">
                <svg class="mx-2 fill-current text-primary-300 h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
            ...
            <a target="_blank" href="https://web.facebook.com/ESI.Page/">
                <svg class="mx-2 fill-current text-primary-300 h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
